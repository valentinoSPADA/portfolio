                            ...
                            <Stack justifyContent={'space-between'} margin={'10px 10px 10px 10px'} alignItems={'center'}>
                                <GridItem>
                                    <Stack bg={'#5F527A'} borderRadius={'10px'} alignItems={'center'} justifyContent={'center'} width={{base: '330px', sm: '450px' , md: "450px" , lg: '450px'}} height={{base: '750', sm: '660px' , md: "660px" , lg: '660px'}}>
                                        ...
                                        <Stack direction={'row'}>
                                            <Button _hover={{ color: '#262626', bg: 'white' }} variant='outline'><a href={p.repositorio[0]} target={'_blank'}>Repositorio</a></Button>
                                            {p.video === "no realizado" ?
                                                <Button _hover={{ color: '#262626', bg: 'white' }} variant='outline'><a href={p.deploy} target={'_blank'}>Deploy</a></Button>
                                                :
                                                <Button _hover={{ color: '#262626', bg: 'white' }} variant='outline'><a href={p.video} target={'_blank'}>Video</a></Button>
                                            }
                                        </Stack>
                                    </Stack>
                                </GridItem>
