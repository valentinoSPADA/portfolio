...
function About() {
    return (
        <Stack bg='#222639' color='#F2F2F2' id='about' minHeight={{base:'1600px' ,sm:'1500px' , md:'1300px' , lg:'100vh'}} fontFamily='"Red Hat Display", sans-serif' direction={{base:'column' ,sm:'column' , md:'column' , lg:'row'}} alignItems={'center'} justifyContent={'space-evenly'}>
            ...
            <Stack direction={'column'} w={{base:'90%' , sm:'85%' , md:'70%' ,lg: '40%'}} bg='#5F527A' alignItems={'center'} borderRadius={'20px'} minHeight='540px' pt={'70px'} paddingLeft='70px' mb={'200px'} paddingRight={'70px'}>
                ...
                <Stack pt={'90px'} w='200px'>
                    <Button variant='outline' marginBottom={'30px'} _hover={{ color: '#262626', bg: 'white' }} fontSize='xl' size='md'><a href='https://drive.google.com/file/d/1QmJxa6gGmfuXGcbNPyi81irC1lkqAGej/view' target={'_blank'}>Descargar CV</a></Button>
                </Stack>
            </Stack>
        </Stack>
    )
